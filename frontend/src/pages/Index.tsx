  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        const response = await fetch('https://gideon-xnf9.onrender.com/auth/me', {
          headers: {
...
const AuthenticatedLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const handleLogout = async () => {
    try {
      // Call backend logout
      await fetch('https://gideon-xnf9.onrender.com/logout', {
        method: 'GET',
        credentials: 'include'
      });
    } catch (error) {
  ...
  useEffect(() => {
    ...
    const initializeApp = async () => {
      try {
        ...
        const healthCheck = await fetch('https://gideon-xnf9.onrender.com/health', {
          method: 'GET',
        ...
        if (!healthCheck || !healthCheck.ok) {
          ...
          toast({
            ...
            description: "Please ensure the backend server is running on https://gideon-xnf9.onrender.com",
            variant: "destructive"
          });
        }
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-gray-300">
            Unable to connect to the backend server. Please ensure it's running on https://gideon-xnf9.onrender.com
          </p>
          <motion.button
