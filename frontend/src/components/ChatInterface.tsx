...
import { 
  ...
  Wifi, WifiOff, RefreshCw, Shield, Database, Code, Terminal
} from 'lucide-react';
...
const MarkdownComponents = {
  ...
  th: ({ children }: any) => (
    <th className="px-4 py-3 text-left text-sm font-semibold text-white border-b border-slate-600">
      {children}
    </th>
  ),
  td: ({ children }: any) => (
  ...
  return (
    <div ref={containerRef} className="min-h-screen flex bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col relative">
          ...
          <div className="relative max-w-7xl mx-auto p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              >
                ...
                <ModelSelector selectedModel={selectedModel} onModelSelect={(modelId: string) => setSelectedModel(modelId as ModelType)} />
              </motion.div>
            </div>
        ...
        {/* Enhanced Input Area - Fixed Visibility */}
        {inputAreaVisible && (
          <motion.div
            className="chat-input border-t border-slate-800/50 backdrop-blur-xl bg-slate-900/50 sticky bottom-0"
